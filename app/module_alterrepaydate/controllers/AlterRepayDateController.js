...
angular.module("pu.alterrepaydate.controllers")
    .controller('AlterRepayDateController',function ($scope, $rootScope, $state,$stateParams ,toaster, $uibModal,LoanQueryService,SettleService,SysDictService,ToolsService) {
